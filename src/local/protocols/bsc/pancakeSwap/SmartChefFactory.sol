...
contract SmartChefFactory is Ownable {
    ...
    // Newly added to allow us to retrieve the deployed pool's addres
    // without relying on events after deploying the pools on local setup
    address[] public smartChefs;
    ...
    function deployPool(
        ...
        // Record for local retrievability
        smartChefs.push(smartChefAddress);
    }

    function getSmartChefs() external view returns (address[] memory) {
        return smartChefs;
    }
}
